        ...
        <div
            ...
            <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
                <div
                    ...
                    <h1 class="mb-1 font-medium">Aplicación Web en Desarrollo</h1>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">El proyecto busca implementar los módulos
                        necesarios para la gestión administrativa de una Institución prestadora de Salud, en adelante
                        IPS. La cual está enfocada en la seguridad y Salud en el Trabajo.

                        <br>Duk Health Software en adelante Duk-Health-Soft, se esta desarrollando en el Framework
                        Laravel, ya que nos proporciona una sintaxis elegante y expresiva..</p>
                    <ul class="flex flex-col mb-4 lg:mb-6">
                        ...
                        <li class="flex items-center gap-4 py-2 relative before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:bottom-1/2 before:top-0 before:start-[0.4rem] before:absolute">
                            ...
                            <span><marquee loop="3">
                                 Funcionalidad 6: Historia Clinica.
                            </span></marquee>
                        </li>
                        <li class="flex items-center gap-4 py-2 relative before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:bottom-1/2 before:top-0 before:start-[0.4rem] before:absolute">
                            <span class="relative py-1 bg-white dark:bg-[#161615]">
                            ...
                            <span>
                                Funcionalidad 7: Modulo -> Empresas.
                            </span>
                        </li>
                        <li class="flex items-center gap-4 py-2 relative before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:bottom-1/2 before:top-0 before:start-[0.4rem] before:absolute">
                            <span class="relative py-1 bg-white dark:bg-[#161615]">

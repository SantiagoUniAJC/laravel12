<flux:header container class="bg-zinc-50 dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-900">
    ...
    <flux:navbar class="-mb-px max-lg:hidden">
        ...
        <flux:navbar.item icon="calendar" href="{{ route('agendas.index') }}" badge="{{ $totalCitasHoy }}">Calendario</flux:navbar.item>
        ...
        @role(['Dev', 'Admin'])
            ...
            <flux:navbar.item icon="user-group" href="{{ route('pacientes.index') }}" label="Pacientes"
                badge="{{ $totalPacientes }}" title="Gestion de Pacientes Registrados">Pacientes
            </flux:navbar.item>

            {{-- Especialistas --}}
            <flux:navbar.item icon="user-group" href="{{ route('especialistas.index') }}" label="Especialistas"
                badge="{{ $totalEspecialistas }}" title="Gestion de Especialistas Registrados">Especialistas
            </flux:navbar.item>

            {{-- usuarios --}}
            <flux:navbar.item icon="users" href="{{ route('usuarios.index') }}" label="Usuarios"
                badge="{{ $totalUsuarios }}" title="Gestion de Usuarios Registrados">Usuarios
            </flux:navbar.item>
        @endrole
